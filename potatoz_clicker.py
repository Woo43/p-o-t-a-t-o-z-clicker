...
def clickplus():
    ...
    clicks = clicks + 1 + rutabagas + carrots + carrots + carrots \
        + spotatoz + spotatoz + spotatoz + spotatoz + spotatoz \
        + spotatoz + spotatoz + spotatoz + spotatoz + spotatoz
    clicker.title('You have ' + str(clicks) + ' potatoz. and '
                  + str(rutabagas) + ' rutabagas and ' + str(carrots)
                  + ' carrots and ' + str(spotatoz) + ' sweet potatoz.')
    print 'You have ' + str(clicks) + ' potatoz. and ' + str(rutabagas) \
        + ' rutabagas and ' + str(carrots) + ' carrots and ' \
        + str(spotatoz) + ' sweet potatoz.'
...
def openshop():
    ...
    rutabagabuy = Button(shop, text='Buy Rutabaga for 500 Potatoz',
                         command=buyrutabaga)
    rutabagabuy.pack()
    ...
    carrotbuy = Button(shop, text='Buy 1 carrot for 1,000 potatoz',
                       command=buycarrot)
    carrotbuy.pack()
    ...
    spotatobuy = Button(shop,
                        text='Buy 1 sweet potato for 2,000 potatoz.',
                        command=buyspotato)
    spotatobuy.pack()
